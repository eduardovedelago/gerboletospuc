...
!function (a) {
    ...
    function P(b, c) {
        ...
        for (f = 0, i = o.length; i > f; f++) for (d = o[f], k = 0, e = d.firstChild; e;) {
            if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) for (l = 1 * e.getAttribute("colspan"), m = 1 * e.getAttribute("rowspan"), l = l && 0 !== l && 1 !== l ? l : 1, m = m && 0 !== m && 1 !== m ? m : 1, j = p(b, f, k), n = 1 === l ? !0 : !1, h = 0; l > h; h++) for (g = 0; m > g; g++) b[f + g][j + h] = {
                "cell": e,
                "unique": n
            }, b[f + g].nTr = d;
            e = e.nextSibling
    ...
    function ya(b) {
        ...
        for (a.isArray(m) && p(m), n && m.pre && p(m.pre), p(b.aaSorting), n && m.post && p(m.post), c = 0; c < o.length; c++) for (j = o[c][0], g = l[j].aDataSort, e = 0, f = g.length; f > e; e++) h = g[e], i = l[h].sType || "string", o[c]._idx === d && (o[c]._idx = a.inArray(o[c][1], l[h].asSorting)), k.push({
            "src": j, "col": h, "dir": o[c][1], "index": o[c]._idx, "type": i,
    ...
    var Ua, Va, Wa, Xa, Ya, Za = {}, $a = /[\r\n]/g, _a = /<.*?>/g, ab = /^[\w\+\-]/, bb = /[\w\+\-]$/,
        ...
        db = /[',$\xc2\xa3\xe2\u201a\xac\xc2\xa5%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, eb = function (a) {
            return a && a !== !0 && "-" !== a ? !1 : !0
        }, fb = function (a) {
            var b = parseInt(a, 10);
    ...
    Xa("cells()", function (b, c, e) {
        ...
        "oLanguage": {
            ...
            "oPaginate": {"sFirst": "Primeiro", "sLast": "Útimo", "sNext": "Próximo", "sPrevious": "Anterior"},
            "sEmptyTable": "Nenhum Registro Localizado",
            "sInfo": "Mostrando de _START_ a _END_ de _TOTAL_ registros",
            "sInfoEmpty": "Mostrando de 0 a 0 de 0 registros",
            "sInfoFiltered": "(Filtrados de _MAX_ total de Registros)",
            "sInfoPostFix": "",
            "sDecimal": "",
            "sThousands": ",",
