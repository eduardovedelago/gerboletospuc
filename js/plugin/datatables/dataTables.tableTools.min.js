        ...
        return f.Client.prototype = {
            ...
            TableTools = function (b, c) {
                ...
                "fnGetSelected": function (a) {
                    ...
                    var f = this, g = a(c).offset(), h = e._collection, i = g.left, j = g.top + a(c).outerHeight(),
                        k = a(b).height(), l = a(d).height(), m = a(b).width(), n = a(d).width();
                    ...
                    (null === c || "collection" != c.sExtends) && null !== this.dom.collection.collection && (a(this.dom.collection.collection).animate({"opacity": 0}, 500, function (a) {
                        this.style.display = "none"
                    ...
                    if (this.s.master) {
                        ...
                        a(c.nTable).addClass(this.classes.select.table), "os" === this.s.select.type && (a(c.nTBody).on("mousedown.DTTT_Select", "tr", function (b) {
                            ...
                            var e = "tr" === this.nodeName.toLowerCase() ? this : a(this).parents("tr")[0],
                                f = b.s.select, g = b.s.dt.oInstance.fnGetPosition(e);
                    ...
                    var c, d, f, g, h, i, j, k = [], l = "", m = this.s.dt, n = new RegExp(b.sFieldBoundary, "g"),
                    ...
                    var e = this.s.dt, f = this.s.print;
                    this.dom.print;
                    ...
                    var b, c, d = this.s.dt, e = d.nScrollHead.getElementsByTagName("div")[0],
