 ...
 * ----------------------------------------------------------- */
$page_title = "Plano Gerencial";
$classPHPNameController = 'form-cad-planoger';
$wEntityName = "models\PlanoGer";
/* -----------------------------------------------------------
 *  ####[alteracao]  ./Variaveis Globais Formulário
 * -----------------------------------------------------------*/
 ...
 * -----------------------------------------------------------*/
$page_nav["cadastros"]["sub"]["contabilidade"]["sub"]["cadastro_planoger"]["active"] = true;
include("inc/nav.php");
?>
    <!-- ==========================CONTENT STARTS HERE ========================== -->
    <!-- MAIN PANEL -->
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                        ...
                        <header>
                            ...
                            <!--* -----------------------------------------------------------*/-->
                            <h2> Listagem de Contas Gerenciais </h2>
                                ...
                                <table id="datatable_cadastro" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:20%">
                                            <input type="text" class="form-control" placeholder="Filtrar Conta"/>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        * -----------------------------------------------------------*/-->
                                        ...
                                        <th data-class="expand">Conta</th>
                                        <th data-hide="phone">Tipo</th>
                                        <th data-class="expand">Conta Contábil</th>
                                        <th>Opções</th>
                                    </tr>
                                    </thead>
                                        ...
                                        if ($listDadosResult != null) {
                                            foreach ($listDadosResult as $dadosObj) {
                                                ...
                                                <tr>
                                                    ...
                                                    * -----------------------------------------------------------*/-->
                                                    <td> <?php echo $dadosObj->getClassificacao() ?> </td>
                                                    <td> <?php echo $dadosObj->getDescricao() ?> </td>
                                                    <td> <?php echo $dadosObj->getConta() ?> </td>
                                                    <td> <?php echo $dadosObj->getTipo() ?> </td>
                                                    <td> <?php echo $dadosObj->getContaContabil() ?> </td>
                                                    <!--/* -----------------------------------------------------------
                                        ...
                                        <form name="form-cadastro" class="smart-form" id="form_cadastro" method="post">
                                            ...
                                            * -----------------------------------------------------------*/-->
                                            ...
                                            <fieldset>
                                                ...
                                                * -----------------------------------------------------------*/-->
                                                <section>
                                                    <?php echo \app\Html::createEdit('edClassificacao', 'ed_classificacao', 'Classificação', 'text', 'fa-file-text-o', 'Informe a Classificação da Conta'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEdit('edConta', 'ed_conta', 'Conta', 'text', 'fa-file-text-o', 'Informe Número da Conta'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEdit('edTipo', 'ed_tipo', 'Tipo da Conta', 'text', 'fa-file-text-o', 'Informe o Tipo da Conta'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEdit('edDescricao', 'ed_descricao', 'Descrição', 'text', 'fa-file-text-o', 'Informe a Descrição do Conta'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEdit('edContaContabil', 'ed_ContaContabil', 'Conta Contábil', 'text', 'fa-file-text-o', 'Informe o Código da Conta Contabil Vinculada'); ?>
                                                </section>
                                            </fieldset>
