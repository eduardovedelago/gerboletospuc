 ...
 * ----------------------------------------------------------- */
$page_title = "Portadores";
$classPHPNameController = 'form-cad-portador';
$wEntityName = "models\Portador";
/* -----------------------------------------------------------
 *  ####[alteracao]  ./Variaveis Globais Formulário
 * -----------------------------------------------------------*/
 ...
 * -----------------------------------------------------------*/
$page_nav["cadastros"]["sub"]["financeiro"]["sub"]["cadastro_portador"]["active"] = true;
include("inc/nav.php");
?>
    <!-- ==========================CONTENT STARTS HERE ========================== -->
    <!-- MAIN PANEL -->
                                        ...
                                        <form name="form-cadastro" class="smart-form" id="form_cadastro" method="post">
                                            ...
                                            * -----------------------------------------------------------*/-->
                                            ...
                                            <fieldset>
                                                ...
                                                * -----------------------------------------------------------*/-->
                                                <section>
                                                    <?php echo \app\Html::createEdit('edDescricao', 'ed_descricao', 'Descrição', 'text', 'fa-file-text-o', 'Informe a Descrição do Portador'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEditSelect('edComportamento', 'ed_comportamento', 'Comportamento', 'text', 'fa-deviantart', 'Informe o Prazo do Portador', true, $listComportamentos, true); ?>
                                                </section>
                                            </fieldset>
