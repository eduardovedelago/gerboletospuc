 ...
 * ----------------------------------------------------------- */
$page_title = "Plano Contábil";
$classPHPNameController = 'form-cad-planocon';
$wEntityName = "models\PlanoCon";
/* -----------------------------------------------------------
 *  ####[alteracao]  ./Variaveis Globais Formulário
 * -----------------------------------------------------------*/
 ...
 * -----------------------------------------------------------*/
$page_nav["cadastros"]["sub"]["contabilidade"]["sub"]["cadastro_planocon"]["active"] = true;
include("inc/nav.php");
?>
    <!-- ==========================CONTENT STARTS HERE ========================== -->
    <!-- MAIN PANEL -->
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                        ...
                        <header>
                            ...
                            <!--* -----------------------------------------------------------*/-->
                            <h2> Listagem de Contas Contábeis</h2>
