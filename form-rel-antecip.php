 ...
 * ----------------------------------------------------------- */
$page_title = "Relatório de Antecipação de Movimentos";
$classPHPNameController = 'form-rel-antecip';
                            ...
                            <div class="widget-body no-padding">
                                <table id="datatable_cadastro"
                                    ...
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:70px">
                                            <input type="date" class="form-control" placeholder="Avaliação"/>
                                        </th>
                                        ...
                                        <th class="hasinput" style="width:50px">
                                            <input type="number" class="form-control" placeholder="Repasse"/>
                                        </th>
                                        <th class="hasinput" style="width:50px">
                                            <input type="number" class="form-control" placeholder="Num. Pend."/>
                                        </th>
                                        <th class="hasinput" style="width:50px">
                                            <input type="hidden" class="form-control" placeholder="Opções"/>
                                        </th>
                                    </tr>
                                    <tr>
                                        <!--/* -----------------------------------------------------------
                                        ...
                                        if ($empr_codigo > 0) {
                                            ...
                                            if ($qb != null) {
                                                $qb->select('a.transacao', 'a.valor', 'a.valorprev', 'a.dataLcto',
                                                    ...
                                                    'aa.dataMvto as dataAvaliacao', 'aa.transacao as transacaoAvaliacao', 'sum(aa.valorRepasse) as valorRepasse',
                                                ...
                                                $qb->leftJoin('models\MovAntecipacaoAnalise', 'aa', 'WITH', 'aa.transacao = p.transacaoAvaliacaoAntecipacao');
                                                ...
                                                $qb->addGroupBy('aa.dataMvto', 'aa.transacao');
                                                $qb->where('a.status <> :status')->setParameter('status', "C");
                                                ...
                                                foreach ($dadosResult as $dadosObj) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        * -----------------------------------------------------------*/-->
                                                        ...
                                                        <td> <?php
                                                            if ($dadosObj['dataAvaliacao'] != null && $dadosObj['dataAvaliacao'] != "") {
                                                                echo $dadosObj['dataAvaliacao']->format('d/m/Y');
                                                            } else {
                                                                echo "N/A";
                                                            }
                                                            ?>
                                                        ...
                                                        <td class="text-align-right"> <?php echo formatFloat($dadosObj['valorRepasse']) ?> </td>
                                                        <td class="text-align-right"> <?php echo $dadosObj['countPF'] ?> </td>
                                                        <td>
                                                            <?php if ($dadosObj['transacaoAvaliacao'] != null && $dadosObj['transacaoAvaliacao'] != "") {
                                                                echo '<a href="/form-print-antecipacao.php?transacao=' . $dadosObj['transacaoAvaliacao'] . '" class="btn btn-primary fa fa-print"> Imprimir</a>';
                                                            }
                                                            ?>
                                                        </td>
                                                    </tr>
