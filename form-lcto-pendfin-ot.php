...
$_acessoForm = \Ctrl\AccessUserCtrl::$Acess_Lctos_PendFin;
                            ...
                            <div class="widget-body">
                                ...
                                <div class="row">
                                    <form id="wizard-1" novalidate="novalidate">
                                        ...
                                        <input id="tipoLcto" name="tipoLcto" type="hidden" value="<?php echo $wTipoLcto?>">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label class="labelsPF" for="ed_pfin_datavcto">Dt. Vcto</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-calendar"></span>
                                                                    <input class="inputsPF"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label class="labelsPF" for="amount">Número Dcto</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <input class="inputsPF"
                                                                           id="ed_pfin_numerodcto"
                                                                           name="ed_pfin_numerodcto"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <label class="labelsPF" for="amount">Descrição /
                                                                    Observações</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <input class="inputsPF"
                                                ...
                                                <div class="tab-pane" id="tab4">
                                                    ...
                                                    <div class="row" <?php if ($wTipoLcto == 2 || $wTipoLcto == 3) echo 'style="display: none"' ?> >
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <label class="labelsPF">Instrução do Boleto</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <input class="inputsPF"
                                                                           class="col-sm-12"
                                                                           placeholder="Mensagem de Instrução do Boleto (Opcional)"
                                                                           id="ed_instrucao" name="ed_instrucao"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row smart-form" <?php if ($wTipoLcto == 2 || $wTipoLcto == 3) echo 'style="display: none"' ?>>
                                                    ...
                                                    <div class="row" <?php if ($wTipoLcto == 1 || $wTipoLcto == 3) echo 'style="display: none"' ?>>
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <label class="labelsPF">Agencia</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <input class="inputsPF"
                                                                           class="col-sm-12"
                                                                           placeholder="Agencia do Cheque"
                                                                           id="ed_agenciacheque" name="ed_agenciacheque"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <label class="labelsPF">Conta Corrente</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <input class="inputsPF"
                                                                           class="col-sm-12"
                                                                           placeholder="CC. do Cheque"
                                                                           id="ed_contacheque" name="ed_contacheque"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <label class="labelsPF">Banco</label>
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <input class="inputsPF"
                                                                           class="col-sm-12"
                                                                           placeholder="Banco do Cheque"
                                                                           id="ed_bancocheque" name="ed_bancocheque"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row smart-form" <?php if ($wTipoLcto == 1 || $wTipoLcto == 3) echo 'style="display: none"' ?>>
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                <div class="flex">
                                                                    <span class="dadosmvto fa fa-file-text"></span>
                                                                    <label class="marginCheckToggle labelsPF toggle">
                                                                        <label class="labelsPF">Cheque Nominal</label>
                                                                        <input class="inputsPF"
                                                                               type="checkbox" name="checkbox-toggle"
                                                                        >
                                                                        <i data-swchon-text="Sim"
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="form-group">
                                                                <div class="flex">
                                                                    ...
                                                                    <input class="inputsPF"
                                                                           class="col-sm-12"
                                                                           placeholder="Nominal Para:"
                                                                           id="ed_nominalcheque"
                                                                           name="ed_nominalcheque"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
