...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/modal-rel-pendfin.css">
...
<body
    <?php
    if ($page_body_prop == null) {
        $page_body_prop = array(
            'class' => 'fixed-header fixed-page-footer smart-style-0'
        );
    }
...
<header id="header">
    ...
    <!--        <span id="project-selector" class="popover-trigger-element dropdown-toggle" data-toggle="dropdown">Recent projects <i-->
    ...
    <div class="pull-right">
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <?php
                    try {
                        if (class_exists("ctrl\UserCtrl")) {
                            $usuario = ctrl\UserCtrl::getObjetoUsuario_Login();
                            if ($usuario != null && $usuario->getNome == null) {
                                echo '<img src="' . ASSETS_URL . '/img/avatars/male.png" alt="' . $usuario->getNome . '" class="online" />';
                            }
                        }
        ...
        <div id="logout" class="btn-header transparent pull-right">
            <span> <a href="<?php echo APP_URL; ?>/logout.php" title="LogOut - " data-action="userLogout"
                      data-logout-msg="Para sua Segurança Após Confirmar essa operação finalize seu browser!"><i
        ...
        <?php
        try {
            if (class_exists("ctrl\UserCtrl") && include_once("src/models/Empresa.php")) {
                $empresa = ctrl\UserCtrl::getObjetoEmpresa_Login();
                if ($empresa != null) {
                    echo '  <label class="label-title-header label label-info margin-top-10 transparent pull-right">';
        ...
        <!--                    <img src="-->
        <?php //echo ASSETS_URL; ?><!--/img/blank.gif" class="flag flag-us" alt="United States"> <span> English(US) </span>-->
        <!--                    <i class="fa fa-angle-down"></i> </a>-->
        <!--                <ul class="dropdown-menu pull-right">-->
        <!--                    <li class="active">-->
        <!--                        <a href="javascript:void(0);"><img src="-->
        <?php //echo ASSETS_URL; ?><!--/img/blank.gif"-->
...
<div id="shortcut">
    <ul>
        ...
        <li>
            <a href="<?php echo APP_URL; ?>/calendar.php" class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span
        ...
        <li>
            <a href="<?php echo APP_URL; ?>/gallery.php" class="jarvismetro-tile big-cubes bg-color-greenLight"> <span
                        class="iconbox"> <i class="fa fa-picture-o fa-4x"></i> <span> Gallery </span> </span> </a>
        </li>
        <li>
            <a href="<?php echo APP_URL; ?>/profile.php" class="jarvismetro-tile big-cubes selected bg-color-pinkDark">
                <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span> My Profile </span> </span> </a>
        </li>
    </ul>
</div>
<!--END SHORTCUT AREA-->
