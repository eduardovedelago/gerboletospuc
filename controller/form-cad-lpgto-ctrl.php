...
// ##
// #####################################################
$entityName = "models\LPgto";
$fieldNameInModal = "codigo";
$locationRedirAfter_Insert_Update = "./form-cad-lpgto.php";
...
// ##
// #####################################################
function validaDadosInsertUpdate(LPgto $LPgto, $isInsert)
{
    $msgDefault = "Validação de Dados: ";
    if ($LPgto == null) {
        return $msgDefault . "Dados do Local de pagamento Inválidos, Null";
    }
    if ($LPgto->getDescricao() == null || $LPgto->getDescricao() == "") {
