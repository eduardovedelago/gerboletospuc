...
$classPHPNameController = 'form-cad-fpgto';
$wEntityName = "models\FPgto";
/* -----------------------------------------------------------
 *  ####[alteracao]  ./Variaveis Globais Formulário
 * -----------------------------------------------------------
 */
 ...
 * -----------------------------------------------------------*/
$listAplicacoes = "";
$listAplicacoes[] = ["CP", " Contas a Pagar"];
$listAplicacoes[] = ["CR", " Contas a Receber"];
 ...
 * -----------------------------------------------------------*/
$page_nav["cadastros"]["sub"]["financeiro"]["sub"]["cadastro_fpgto"]["active"] = true;
include("inc/nav.php");
?>
    <!-- ==========================CONTENT STARTS HERE ========================== -->
    <!-- MAIN PANEL -->
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
                        ...
                        <header>
                            ...
                            <!--* -----------------------------------------------------------*/-->
                            <h2> Listagem de Formas de Pagamento </h2>
                                ...
                                <table id="datatable_cadastro" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:10%">
                                            <input type="text" class="form-control" placeholder="Filtrar Aplicação"/>
                                        </th>

                                        <th class="hasinput" style="width:25%">
                                            <input type="text" class="form-control" placeholder="Filtrar Prazo"/>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        * -----------------------------------------------------------*/-->
                                        ...
                                        <th data-hide="phone">Prazos</th>
                                        <th data-hide="phone">Aplicação</th>
                                            ...
                                            foreach ($listDadosResult as $dadosObj) {
                                                ...
                                                <tr>
                                                    ...
                                                    * -----------------------------------------------------------*/-->
                                                    ...
                                                    <td> <?php echo $dadosObj->getPrazos() ?> </td>
                                                    <td> <?php echo $dadosObj->getAplicacao() ?> </td>
                                        ...
                                        <form name="form-cadastro" class="smart-form" id="form_cadastro" method="post">
                                            ...
                                            * -----------------------------------------------------------*/-->
                                            ...
                                            <fieldset>
                                                ...
                                                * -----------------------------------------------------------*/-->
                                                <section>
                                                    <?php echo \app\Html::createEdit('edDescricao', 'ed_descricao', 'Descrição', 'text', 'fa-file-text-o', 'Informe a Descrição da Forma de Pagamento'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEdit('edPrazos', 'ed_prazos', 'Prazos', 'text', 'fa-calendar', 'Informe o Prazo da Forma de Pagamento'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEditSelect('edAplicacao', 'ed_aplicacao', 'Aplicação', 'text', 'fa-circle-o-notch', 'Informe a Aplicação da Forma de Pagamento', true, $listAplicacoes, true); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEditSelect('edComportamento', 'ed_comportamento', 'Comportamento', 'text', 'fa-deviantart', 'Informe o Prazo da Forma de Pagamento', true, $listComportamentos, true); ?>
                                                </section>
                                            </fieldset>
