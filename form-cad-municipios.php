...
$classPHPNameController = 'form-cad-municipios';
$wEntityName = "models\Municipio";
/* -----------------------------------------------------------
 *  ####[alteracao]  ./Variaveis Globais Formulário
 * -----------------------------------------------------------
 */
...
$_acessoForm = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios;

//Variaveis de CRUD
$_acessoIncluir = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Incluir;
$_acessoAlterar = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Alterar;
$_acessoExcluir = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Excluir;

//Variáveis de Acesso as Opções
$_acessoCopy =\Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Opcoes;
$_acessoPDF = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Opcoes;
$_acessoExcel = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Opcoes;
$_acessoPrinter = \Ctrl\AccessUserCtrl::$Acess_Cadastro_Municipios_Opcoes;
/* -----------------------------------------------------------
...
$listUFs[] = ["BA", " Bahia"];
$listUFs[] = ["CE", " Ceará"];
$listUFs[] = ["DF", " Distrito Federal"];
$listUFs[] = ["ES", " Espírito Santo"];
$listUFs[] = ["GO", " Goiás"];
$listUFs[] = ["MA", " Maranhão"];
$listUFs[] = ["MG", " Minas Gerais"];
$listUFs[] = ["MT", " Mato Grosso"];
$listUFs[] = ["MS", " Mato Grosso dos Sul"];
$listUFs[] = ["PA", " Pará"];
$listUFs[] = ["PR", " Paraná"];
$listUFs[] = ["PB", " Paraíba"];
$listUFs[] = ["PE", " Pernambuco"];
$listUFs[] = ["PI", " Piauí"];
$listUFs[] = ["RN", " Rio Grande do Norte"];
$listUFs[] = ["RO", " Rondonia"];
$listUFs[] = ["RR", " Roraima"];
$listUFs[] = ["RJ", " Rio de Janeiro"];
$listUFs[] = ["SC", " Santa Catarina"];
$listUFs[] = ["RS", " Rio Grande do Sul"];
$listUFs[] = ["SE", " Sergipe"];
$listUFs[] = ["SP", " São Paulo"];
$listUFs[] = ["TO", " Tocantins"];
 ...
 * -----------------------------------------------------------*/
$page_nav["cadastros"]["sub"]["cadastro_municipios"]["active"] = true;
include("inc/nav.php");
?>
    <!-- ==========================CONTENT STARTS HERE ========================== -->
    <!-- MAIN PANEL -->
                                ...
                                <table id="datatable_cadastro" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:10%">
                                            <input type="text" class="form-control" placeholder="Filtrar UF"/>
                                        </th>
                                        ...
                                        <form name="form-cadastro" class="smart-form" id="form_cadastro" method="post">
                                            ...
                                            * -----------------------------------------------------------*/-->
                                            ...
                                            <fieldset>
                                                ...
                                                * -----------------------------------------------------------*/-->
                                                <section>
                                                    <?php echo \app\Html::createEdit('edNome', 'ed_nome', 'Nome', 'text', 'fa-file-text-o', 'Informe o Nome do Município'); ?>
                                                </section>
                                                <section>
                                                    <?php echo \app\Html::createEditSelectSimple('edUF', 'ed_uf', 'UF', $listUFs); ?>
                                                </section>
                                            </fieldset>
