                    ...
                    <div class="col-sm-12">
                        <div class="text-center error-box">
                            <h2 class="error-text-3 bounceInDown animated"><i
                                        class="fa fa-fw fa-warning fa-lg text-warning"></i> Acesso Não Autorizado<span
                                        class="particle particle--c"></span><span
                                        class="particle particle--a"></span><span class="particle particle--b"></span>
                            </h2>
                            <br><br><br><br>

                            <h1 class="font-xl"><strong>Seu Pacote Não Permite Acesso e Este Recurso <br>Acesso <u>Não</u> Autorizado a página solicitada </strong></h1>

                            <h1 class="font-xl"><strong>Para Incluir esse Recurso ao Seu Sistema Entre em Contato Conosco</strong></h1>
                            <br/>
                            <p class="lead">
                            ...
                            <p class="font-md">
                                ...
                                <b>Voce está sendo redirecionado para HOME, em <span id="countdown">10</span>
