 ...
 * ----------------------------------------------------------- */
$page_title = "Cancelamento de Movimentos";
$classPHPNameController = 'form-proc-cancel-blt';
...
$_acessoForm = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;

//Variaveis de CRUD
$_acessoIncluir = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;
$_acessoAlterar = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;
$_acessoExcluir = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;

//Variáveis de Acesso as Opções
$_acessoCopy = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;
$_acessoPDF = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;
$_acessoExcel = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;
$_acessoPrinter = \Ctrl\AccessUserCtrl::$Acess_Proc_CancelBlt;
/* -----------------------------------------------------------
 ...
 * -----------------------------------------------------------*/
$page_nav["procedimentos"]["sub"]["proc_canc_blt"]["active"] = true;
include("inc/nav.php");
?>
    <!-- ==========================CONTENT STARTS HERE ========================== -->
    <!-- MAIN PANEL -->
                                    ...
                                    <fieldset>
                                        ...
                                        <div id="section_operacao_2" hidden>
                                            ...
                                            <div class="row">
                                                ...
                                                <section class="col col-2 align-right-txt txt-align-center-ho">
                                                    <button style="width: 150px;" id="btnExecuteCancelamento" type="button" class="btn btn-warning btn-labeled text-center ">
